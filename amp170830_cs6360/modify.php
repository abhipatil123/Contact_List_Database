        ...
        <div class = "container">
            <fieldset class="scheduler-border">
                ...
                <div id="Name">
                    <table>
                        <tr>
                            <td > <input type="text" name="first_name" size="30" value= '<?php echo $Fname?>' class="form-control" requied/></td>
                        </tr>

                        <tr>
                            <td > <input type="text" name="middle_name" size="30" value='<?php echo $Mname?>' class="form-control" requied/></td>
                        </tr>

                        <tr>
                            <td > <input type="text" name="last_name" size="30" value='<?php echo $Lname?>' class="form-control" requied/></td>
                        </tr>
                    </table>
                </div>
            </fieldset>
